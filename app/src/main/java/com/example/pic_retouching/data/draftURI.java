...
public class draftURI {

    private Database database;

    public draftURI (Context context){
        this.database = new Database(context);
    }

    public void insert(int index, String picUri){
        SQLiteDatabase db = database.getWritableDatabase();

        String insert_sql = "INSERT INTO " + Database.DRAFT +
                " (position, image) VALUES (?,?)";
        Object[] obj = {index, picUri};
    ...
    public void update(int position, String picUri, int isEdit){
        ...
        String update_sql = "UPDATE " + Database.DRAFT + " SET image = '" + picUri +
...
//        }// broaden the cursor window to 100 MB
    ...
    public void delete(int position){
        ...
        String delete_sql = " DELETE FROM " + Database.DRAFT +
    ...
    public Object[] query(int position) {
        ...
        String query_sql = " SELECT * FROM " + Database.DRAFT +
                " WHERE position = " + position;
    ...
    public String queryUri(int position){
        SQLiteDatabase db = database.getReadableDatabase();
